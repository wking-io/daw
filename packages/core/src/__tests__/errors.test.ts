...
describe("errors", () => {
  describe("BadRequest", () => {
    it("creates with default values", () => {
      ...
      expect(error.type).toBe("https://developer.mozilla.org/en-US/docs/Web/HTTP/Status/400");
    });
  ...
  describe("Unauthorized", () => {
    it("creates with default values", () => {
      ...
      expect(error.type).toBe("https://developer.mozilla.org/en-US/docs/Web/HTTP/Status/401");
    });
  ...
  describe("Forbidden", () => {
    it("creates with default values", () => {
      ...
      expect(error.type).toBe("https://developer.mozilla.org/en-US/docs/Web/HTTP/Status/403");
    });
  ...
  describe("NotFound", () => {
    it("creates with default values", () => {
      ...
      expect(error.type).toBe("https://developer.mozilla.org/en-US/docs/Web/HTTP/Status/404");
    });
  ...
  describe("Conflict", () => {
    it("creates with default values", () => {
      ...
      expect(error.type).toBe("https://developer.mozilla.org/en-US/docs/Web/HTTP/Status/409");
    });
  ...
  describe("UnprocessableEntity", () => {
    it("creates with default values", () => {
      ...
      expect(error.type).toBe("https://developer.mozilla.org/en-US/docs/Web/HTTP/Status/422");
    });
  ...
  describe("InternalServerError", () => {
    it("creates with default values", () => {
      ...
      expect(error.type).toBe("https://developer.mozilla.org/en-US/docs/Web/HTTP/Status/500");
    });
