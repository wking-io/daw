...
export class BadRequest extends Schema.TaggedError<BadRequest>()(
  "BadRequest",
  {
    ...
    type: Schema.optionalWith(Schema.String, {
      default: () => "https://developer.mozilla.org/en-US/docs/Web/HTTP/Status/400",
    }),
...
export class Unauthorized extends Schema.TaggedError<Unauthorized>()(
  ...
  {
    type: Schema.optionalWith(Schema.String, {
      default: () => "https://developer.mozilla.org/en-US/docs/Web/HTTP/Status/401",
    }),
    title: Schema.optionalWith(Schema.String, {
...
export class Forbidden extends Schema.TaggedError<Forbidden>()(
  ...
  {
    type: Schema.optionalWith(Schema.String, {
      default: () => "https://developer.mozilla.org/en-US/docs/Web/HTTP/Status/403",
    }),
    title: Schema.optionalWith(Schema.String, {
      default: () => "Forbidden",
    }),
...
export class NotFound extends Schema.TaggedError<NotFound>()(
  ...
  {
    type: Schema.optionalWith(Schema.String, {
      default: () => "https://developer.mozilla.org/en-US/docs/Web/HTTP/Status/404",
    }),
    title: Schema.optionalWith(Schema.String, {
      default: () => "Not Found",
    }),
...
export class NotAcceptable extends Schema.TaggedError<NotAcceptable>()(
  ...
  {
    type: Schema.optionalWith(Schema.String, {
      default: () => "https://developer.mozilla.org/en-US/docs/Web/HTTP/Status/406",
    }),
    title: Schema.optionalWith(Schema.String, {
  ...
  problemAnnotations({
    status: 406,
    description: "The response is not acceptable according to the acceptable values.",
  }),
) {}
...
export class Gone extends Schema.TaggedError<Gone>()(
  ...
  {
    type: Schema.optionalWith(Schema.String, {
      default: () => "https://developer.mozilla.org/en-US/docs/Web/HTTP/Status/410",
    }),
    title: Schema.optionalWith(Schema.String, {
      default: () => "Gone",
    }),
...
export class Conflict extends Schema.TaggedError<Conflict>()(
  ...
  {
    type: Schema.optionalWith(Schema.String, {
      default: () => "https://developer.mozilla.org/en-US/docs/Web/HTTP/Status/409",
    }),
    title: Schema.optionalWith(Schema.String, {
      default: () => "Conflict",
    }),
...
export class UnprocessableEntity extends Schema.TaggedError<UnprocessableEntity>()(
  ...
  {
    type: Schema.optionalWith(Schema.String, {
      default: () => "https://developer.mozilla.org/en-US/docs/Web/HTTP/Status/422",
    }),
    title: Schema.optionalWith(Schema.String, {
...
export class InternalServerError extends Schema.TaggedError<InternalServerError>()(
  ...
  {
    type: Schema.optionalWith(Schema.String, {
      default: () => "https://developer.mozilla.org/en-US/docs/Web/HTTP/Status/500",
    }),
    title: Schema.optionalWith(Schema.String, {
