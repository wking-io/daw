...
export function isValid<A extends number>(N: Numeric<A>, t: Timeline<A>): boolean {
...
export function normalize<A extends number>(N: Numeric<A>, t: Timeline<A>): Timeline<A> {
...
export function eq<A extends number>(N: Numeric<A>, a: Timeline<A>, b: Timeline<A>): boolean {
...
export function panBy<A extends number>(N: Numeric<A>, t: Timeline<A>, delta: A): Timeline<A> {
