...
export type AutomationLaneCreated = Schema.Schema.Type<
	typeof AutomationLaneCreated
>;
...
export type AutomationLaneDeleted = Schema.Schema.Type<
	typeof AutomationLaneDeleted
>;
...
export type AutomationPointAdded = Schema.Schema.Type<
	typeof AutomationPointAdded
>;
...
export type AutomationPointDeleted = Schema.Schema.Type<
	typeof AutomationPointDeleted
>;
...
export type AutomationPointMoved = Schema.Schema.Type<
	typeof AutomationPointMoved
>;
...
export type AutomationPointCurveChanged = Schema.Schema.Type<
	typeof AutomationPointCurveChanged
>;
