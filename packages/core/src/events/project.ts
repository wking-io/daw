...
export type ProjectTempoChanged = Schema.Schema.Type<typeof ProjectTempoChanged>;

export const ProjectTimeSignatureChanged = Schema.Struct({
  t: Schema.Literal("project.timeSignatureChanged"),
  timeSignature: TimeSignature,
});
export type ProjectTimeSignatureChanged = Schema.Schema.Type<typeof ProjectTimeSignatureChanged>;
...
export type ProjectTracksReordered = Schema.Schema.Type<typeof ProjectTracksReordered>;
