...
export type AudioFileRegistered = Schema.Schema.Type<typeof AudioFileRegistered>;

export const AudioFileUnregistered = Schema.Struct({
  t: Schema.Literal("audioFile.unregistered"),
  audioFileId: Ids.AudioFileId,
});
export type AudioFileUnregistered = Schema.Schema.Type<typeof AudioFileUnregistered>;
