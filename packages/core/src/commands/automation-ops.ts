...
export type AutomationCreateLane = Schema.Schema.Type<typeof AutomationCreateLane>;

export const AutomationDeleteLane = Schema.Struct({
  t: Schema.Literal("automation.deleteLane"),
  laneId: AutomationLaneId,
});
export type AutomationDeleteLane = Schema.Schema.Type<typeof AutomationDeleteLane>;
...
export type AutomationDeletePoint = Schema.Schema.Type<typeof AutomationDeletePoint>;
...
export type AutomationSetPointCurve = Schema.Schema.Type<typeof AutomationSetPointCurve>;
...
export type AutomationOperation = Schema.Schema.Type<typeof AutomationOperation>;
