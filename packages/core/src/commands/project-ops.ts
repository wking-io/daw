...
export type ProjectSetTimeSignature = Schema.Schema.Type<typeof ProjectSetTimeSignature>;

export const ProjectReorderTracks = Schema.Struct({
  t: Schema.Literal("project.reorderTracks"),
  trackIds: Schema.Array(TrackId),
});
export type ProjectReorderTracks = Schema.Schema.Type<typeof ProjectReorderTracks>;
