...
export function CloseTrigger(_handle: Handle) {
  return (props: Tabs.CloseTrigger.Props) => {
    ...
    return (
      <Tabs.CloseTrigger
        {...buttonProps}
        class={cn(classes, "p-2 -my-2 -ml-1 -mr-2 opacity-50 hover:opacity-100")}
      >
        {children}
      </Tabs.CloseTrigger>
    );
