...
const n = (pitch: number, start: number, size: number, velocity = 100) => ({
  ...
  pitch,
  velocity,
  span: Span.make(QN.Numeric, start, size),
});
...
export const demoProject: Project = {
  ...
  clips: [
    // Drums (t1)
    {
      ...
      sortOrder: 0,
      payload: { kind: "midi", patternId: p1 },
    },
    {
      id: generate("ClipId"),
      projectId,
      ...
      loop: { enabled: false, length: QN.QN(32) },
      sortOrder: 1,
      payload: { kind: "midi", patternId: p2 },
    },
    // Bass (t2)
    {
      id: generate("ClipId"),
      ...
      sortOrder: 0,
      payload: { kind: "midi", patternId: p3 },
    },
    // Keys (t3)
    {
      id: generate("ClipId"),
      ...
      loop: { enabled: false, length: QN.QN(32) },
      sortOrder: 0,
      payload: { kind: "midi", patternId: p4 },
    },
    {
      id: generate("ClipId"),
      projectId,
      ...
      sortOrder: 1,
      payload: { kind: "midi", patternId: p5 },
    },
    // Vox (t4)
    {
      id: generate("ClipId"),
      ...
      sortOrder: 0,
      payload: { kind: "midi", patternId: p6 },
    },
    {
      id: generate("ClipId"),
      projectId,
      ...
      loop: { enabled: false, length: QN.QN(28) },
      sortOrder: 1,
      payload: { kind: "midi", patternId: p7 },
    },
    // FX (t5)
    {
      id: generate("ClipId"),
      ...
      sortOrder: 0,
      payload: { kind: "midi", patternId: p8 },
    },
    {
      id: generate("ClipId"),
      projectId,
      ...
      sortOrder: 1,
      payload: { kind: "midi", patternId: p9 },
    },
    // Pads (t6)
    {
      id: generate("ClipId"),
      ...
      sortOrder: 0,
      payload: { kind: "midi", patternId: p10 },
    },
    // Lead (t7)
    {
      id: generate("ClipId"),
      ...
      loop: { enabled: false, length: QN.QN(16) },
      sortOrder: 0,
      payload: { kind: "midi", patternId: p11 },
    },
    {
      id: generate("ClipId"),
      projectId,
      ...
      loop: { enabled: false, length: QN.QN(24) },
      sortOrder: 1,
      payload: { kind: "midi", patternId: p12 },
    },
    // Perc (t8)
    {
      id: generate("ClipId"),
      ...
      sortOrder: 0,
      payload: { kind: "midi", patternId: p13 },
    },
    {
      id: generate("ClipId"),
      projectId,
      ...
      loop: { enabled: false, length: QN.QN(16) },
      sortOrder: 1,
      payload: { kind: "midi", patternId: p14 },
    },
    {
      id: generate("ClipId"),
      projectId,
      ...
      loop: { enabled: false, length: QN.QN(28) },
      sortOrder: 2,
      payload: { kind: "midi", patternId: p15 },
    },
    // Samples (t9) — audio clips
    {
      ...
      loop: { enabled: false, length: QN.QN(32) },
      sortOrder: 0,
      payload: { kind: "audio", audioFileId: af1, offsetSec: 0 },
    },
    {
      id: generate("ClipId"),
      projectId,
      ...
      loop: { enabled: false, length: QN.QN(24) },
      sortOrder: 1,
      payload: { kind: "audio", audioFileId: af2, offsetSec: 0 },
    },
    {
      id: generate("ClipId"),
      projectId,
      ...
      loop: { enabled: false, length: QN.QN(32) },
      sortOrder: 2,
      payload: { kind: "audio", audioFileId: af3, offsetSec: 2.5 },
    },
    // Guitar (t10) — audio clips
    {
      ...
      loop: { enabled: false, length: QN.QN(32) },
      sortOrder: 0,
      payload: { kind: "audio", audioFileId: af4, offsetSec: 0 },
    },
    {
      id: generate("ClipId"),
      projectId,
      ...
      loop: { enabled: false, length: QN.QN(32) },
      sortOrder: 1,
      payload: { kind: "audio", audioFileId: af5, offsetSec: 0 },
    },
    // Vocals (t11) — audio clips
    {
      ...
      sortOrder: 0,
      payload: { kind: "audio", audioFileId: af6, offsetSec: 0 },
    },
    {
      id: generate("ClipId"),
      projectId,
      ...
      loop: { enabled: false, length: QN.QN(28) },
      sortOrder: 1,
      payload: { kind: "audio", audioFileId: af7, offsetSec: 1.2 },
    },
    // Ambient (t12) — audio clips
    {
      ...
      sortOrder: 0,
      payload: { kind: "audio", audioFileId: af8, offsetSec: 0 },
    },
    {
      id: generate("ClipId"),
      projectId,
      ...
      sortOrder: 1,
      payload: { kind: "audio", audioFileId: af9, offsetSec: 0 },
    },
    // Synth Pad (t13) — audio clips
    {
      ...
      loop: { enabled: false, length: QN.QN(48) },
      sortOrder: 0,
      payload: { kind: "audio", audioFileId: af10, offsetSec: 0 },
    },
  ],
  midiPatterns: [
