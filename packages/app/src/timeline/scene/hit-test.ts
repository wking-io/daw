...
function hitTestNode<Action>(node: InteractiveNode<Action>, point: Point): Action | null {
  switch (node.kind) {
    case "rect": {
 ...
 */
function isPointNearLine(point: Point, linePoints: readonly Point[], tolerance: number): boolean {
